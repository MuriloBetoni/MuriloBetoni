...
academic_education = {'curso':'Sistemas de Informação', 'faculdade':'Universidade Metodista de São Paulo', 'conclusao':'12/2022'}
...
print(f"{negrito}Formação{limpa} \nBacharelado em {academic_education['curso']} \n{academic_education['faculdade']} \nConcluído em {academic_education['conclusao']} \n")
